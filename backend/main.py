...
async def startup_event():
    try:
        ...
        data_list = [
            ...
            ("Database optimization", "Improve query performance", "Access", "high", "open", "backend_team", "2025-06-05 16:45:00"),
            ("Mobile app crash", "App crashes on startup for iOS users", "Security", "critical", "in_progress", "mobile_team", "2025-11-28 11:20:00"),
            ("Email notifications", "Add email alerts for ticket updates", "Software", "medium", "open", "dev_team", "2025-06-03 08:00:00"),
            ...
            ("API rate limiting", "Implement rate limiting for APIs", "Access", "low", "open", "backend_team", "2025-06-07 12:30:00"),
            ("User feedback", "Analyze user survey responses", "Security", "low", "closed", "product_team", "2025-10-05 17:00:00"),
            ("Payment integration", "Integrate Stripe for payments", "Software", "high", "in_progress", "dev_team", "2025-11-30 10:45:00"),
            ...
            ("Code review", "Review pull requests", "Security", "medium", "open", "dev_team", "2025-12-04 09:00:00"),
